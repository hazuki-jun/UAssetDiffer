...
#include "AssetDifferSupportClassFactory.generated.h"

/**
 * 
 */
UCLASS()
class UASSETDIFFEREDITOR_API UAssetDifferSupportClassFactory : public UObject
{
	GENERATED_BODY()

public:
	UAssetDifferSupportClassFactory();
