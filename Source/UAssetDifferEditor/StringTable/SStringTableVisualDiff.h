 ...
 * 
 */
class UASSETDIFFEREDITOR_API SStringTableVisualDiff : public SVisualDiffWidget
{
public:
...
public:
	 ...
	 */
	EDifferRowViewOption GetRowState(bool bIsLocal, const FString& RowKey);
...
protected:
	TSharedPtr<class SAssetDifferStringTableListView> StringTableListViewLocal;
	TSharedPtr<class SAssetDifferStringTableListView> StringTableListViewRemote;
