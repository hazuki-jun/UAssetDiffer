 ...
 * 
 */
class UASSETDIFFEREDITOR_API SAssetDifferDataTableLayout : public SCompoundWidget
{
public:
	SLATE_BEGIN_ARGS(SAssetDifferDataTableLayout){}
	...
	TSharedRef<ITableRow> MakeRowWidget(FAssetDifferDataTableRowListViewDataPtr InRowDataPtr, const TSharedRef<STableViewBase>& OwnerTable);
...
public:
	...
	TArray<FAssetDifferDataTableRowListViewDataPtr>& GetVisibleRows();
...
protected:
	...
	TArray<FAssetDifferDataTableRowListViewDataPtr> VisibleRows;

	TSharedPtr<SListView<FAssetDifferDataTableRowListViewDataPtr>> ListView;
